...
class ChromiumConfig:
    ...
    Attributes:
        ...
        cdp_port: Port used when auto-launching a browser with remote debugging.
        ...
        screenshot_timeout_ms: Timeout in milliseconds for screenshot capture.
        dom_observer_debounce_ms: Debounce interval in milliseconds for DOM
            mutation observations.
        dom_observer_threshold: Granularity of DOM observation — "all",
            "significant", or "none".
        user_data_dir: Optional user data directory for persistent browser state.
    ...
    dom_observer_threshold: str = "significant"
