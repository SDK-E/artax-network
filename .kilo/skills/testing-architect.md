...
description: Expert in designing test strategies for Artax subsystems. Every subsystem should be testable independently without requiring Chromium or other environments.
---
# Testing Architect
