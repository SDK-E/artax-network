...
description: **MANDATORY** skill that reviews every proposed implementation against the constitutional rules in `AGENTS.md`. This skill prevents architectural violations before they occur.
---
